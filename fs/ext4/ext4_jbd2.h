...
#ifdef MULTY_JOURNAL
int ext4_hash_blocknr(struct inode *inode);
#endif
...
handle_t *__ext4_journal_start_sb(struct super_block *sb, unsigned int line,
				  int type, int blocks, int rsv_blocks, int h);
#else
handle_t *__ext4_journal_start_sb(struct super_block *sb, unsigned int line,
...
#ifdef MULTY_JOURNAL
#define ext4_journal_start_sb(sb, type, nblocks, h)            \
    __ext4_journal_start_sb((sb), __LINE__, (type), (nblocks), 0, (h))
#else
					     ...
					     int blocks, int rsv_blocks)
{
	...
	return __ext4_journal_start_sb(inode->i_sb, line, type, blocks,
				       rsv_blocks, ext4_hash_blocknr(inode));
#else
    return __ext4_journal_start_sb(inode->i_sb, line, type, blocks,
                       rsv_blocks);
#endif
