				...
				struct ext4_new_flex_group_data *flex_gd)
{
	...
	handle = ext4_journal_start_sb(sb, EXT4_HT_RESIZE, EXT4_MAX_TRANS_DATA, -1);
#else
...
#ifdef MULTY_JOURNAL
	handle = ext4_journal_start_sb(sb, EXT4_HT_RESIZE, credit, -1);
#else
				      ...
				      ext4_fsblk_t o_blocks_count, ext4_grpblk_t add)
{
	 ...
	 */
#ifdef MULTY_JOURNAL
	handle = ext4_journal_start_sb(sb, EXT4_HT_RESIZE, 3, -1);
#else
